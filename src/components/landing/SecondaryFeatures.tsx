...
const features = [
  ...
  },
  {
    ...
    description: "Whether you're focused on growth, income, or preservation, we have the right mix of investments for you.",
    icon: DeviceCardsIcon
  },
  {
    name: "Trade with confidence",
    description: "Our AI-powered trading system helps you make the right decisions at the right time.",
    icon: DeviceClockIcon
  },
  {
    name: "Secure your future",
    description: "With bank-grade security and encryption, your investments are always protected.",
    icon: DeviceListIcon
  },
  {
    name: "Track your progress",
    description: "Monitor your portfolio performance in real-time and get insights to help you grow your wealth.",
    icon: DeviceLockIcon
  },
  {
    name: "Expert support",
    description: "Our team of financial experts is always available to help you make the most of your investments.",
